                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="flex items-center space-x-2 mt-3">
                              <motion.button
                                ...
                                className="flex-1 bg-stone-800 hover:bg-stone-900 disabled:bg-stone-300 disabled:cursor-not-allowed text-white text-xs py-2 px-3 rounded-md transition-colors"
                              >
